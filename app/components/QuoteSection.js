...
const carBrands = {
  BMW: ["3 Series", "5 Series", "7 Series", "X5", "X6", "M3", "M4", "1M", "128i", "135i", "M235i", "M240i", "X7", "XM", "Z3", "Z4", "Z8"],
  Audi: ["A3", "A4", "A6", "Q5", "Q7", "Q8", "RS7", "E-tron", "Q3", "Q4 E-tron", "E-tron GT", "RS Q8", "S4", "RS6", "RS5"],
  Toyota: ["Corolla", "Camry", "RAV4", "Highlander", "Land Cruiser", "Supra", "GR Supra", "Tacoma", "Tundra", "Yaris", "BZ4X"],
  Honda: ["Civic", "Accord", "CR-V", "Pilot", "Fit", "Odyssey", "Element", "Insight", "HRV", "Ridgeline", "S2000"],
  Ford: ["F-150", "Mustang", "Escape", "Explorer", "Fusion", "Ranger", "Maverick", "Bronco", "Mustang Mach E", "Edge"],
  Chevrolet: ["Cruze", "Malibu", "Equinox", "Tahoe", "Silverado", "TrailBlazer", "Blazer EV", "Bolt", "Suburban", "Camaro"],
  Mercedes: ["C-Class", "E-Class", "S-Class", "GLC", "GLS", "A-Class", "EQE", "EQS", "GLE", "GLB", "AMG GT"],
  Nissan: ["Altima", "Maxima", "Pathfinder", "Sentra", "Titan", "Rogue", "Murano", "Leaf", "370Z", "Ariya"],
  Volkswagen: ["Golf", "Passat", "Jetta", "Tiguan", "Atlas", "ID.4", "Taos", "Arteon"],
  Subaru: ["Impreza", "Outback", "Forester", "Crosstrek", "Legacy", "WRX", "Ascent"],
  Tesla: ["Model S", "Model 3", "Model X", "Model Y", "Roadster"],
  Hyundai: ["Elantra", "Sonata", "Tucson", "Palisade", "Santa Fe", "Ioniq 5", "Kona", "Veloster", "Nexo"],
  Kia: ["Optima", "Soul", "Sportage", "Sorento", "Stinger", "EV6", "Telluride"],
  Lexus: ["RX", "NX", "ES", "IS", "GX", "LX", "RC F", "LS", "RX500h"],
  Jaguar: ["F-Type", "XE", "XF", "XJ", "F-PACE", "E-PACE", "I Pace"],
  LandRover: ["Range Rover", "Discovery", "Defender", "Evoque", "Sport", "Velar"],
  ...
  Buick: ["Encore", "Envision", "LaCrosse", "Regal", "Enclave", "Encore GX"],
  Volvo: ["XC40", "XC60", "XC90", "S60", "S90", "V60", "C40", "XC70", "V90"],
  Acura: ["CL", "CSX", "ILX", "MDX", "NSX", "RDX", "TLX", "TSX"],
  AlfaRomeo: ["Giulia", "Stelvio", "Tonale", "4C", "Spider"],
  AstonMartin: ["DB11", "Vantage", "DBS", "Rapide", "DBX"],
  Bentley: ["Bentayga", "Continental", "Flying Spur", "Mulsanne"],
  Cadillac: ["Escalade", "XT5", "XT6", "CT5", "LYRIQ"],
  Genesis: ["G70", "G80", "G90", "GV60", "GV80"],
  Infiniti: ["Q50", "Q60", "QX50", "QX60", "QX80"],
  LandRover: ["Defender", "Discovery", "Range Rover", "Velar", "Evoque"],
  McLaren: ["Artura", "720S", "GT", "P1", "Senna"],
  Mini: ["Cooper", "Countryman", "Clubman"],
  Polestar: ["1", "2"],
  Rivian: ["R1T", "R1S"],
  RollsRoyce: ["Phantom", "Ghost", "Wraith", "Cullinan", "Dawn"],
  Scion: ["FRS", "tC", "xB", "xD"],
  Smart: ["Fortwo"],
  Suzuki: ["Swift", "Vitara", "Jimny", "SX4", "XL7"],
  Lucid: ["Air", "Gravity"],
};
